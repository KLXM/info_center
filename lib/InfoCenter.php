...
class InfoCenter
{
    ...
    public function get(): string 
    {
        ...
        if (rex::isBackend() && rex::getUser()) {
            $headerButtons = '
                <div class="info-center-header-buttons">
                    <a href="' . rex_url::backendPage('info_center/config') . '" class="info-center-settings-btn" title="Info Center Einstellungen">
                    ...
                    <button class="info-center-close-btn" title="Info Center schließen">
                        <svg class="info-center-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        elseif (rex::isFrontend() && rex_backend_login::createUser()) {
            $headerButtons = '
                <div class="info-center-header-buttons">
                    <button class="info-center-backend-btn" title="Zum Backend wechseln" onclick="window.location.href=\'' . rex_url::backendController() . '\'">
                        <svg class="info-center-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
